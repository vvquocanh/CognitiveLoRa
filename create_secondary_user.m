function [user_information, sensing_data] = create_secondary_user(amplitude_modulated_signal, signal_length, sampling_frequency, threshold)
    ...
    if isempty(lora_signal)
        ...
        [new_amplitude_modulated_signal, center_frequency, beginning_index, last_index] = secondary_user_enter(amplitude_modulated_signal, lora_signal, bandwidth, sampling_frequency, threshold);
    end
