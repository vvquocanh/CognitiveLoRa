...
while true
    ...
    switch command
        ...
        case "create_primary"
            [environment_signal, user_information, secondary_users] = create_primary_user(amplitude_modulated_signal, signal_length, sampling_frequency, secondary_users, secondary_users_sensing_data, power_threshold);
